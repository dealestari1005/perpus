				...
				<ul class="sidebar-menu">
					...
					?>
						...
						<li class="treeview">
							...
							<ul class="treeview-menu">
								...
								<li>
									<a href="?page=MyApp/data_buku_petugas">
										<i class="fa fa-book"></i>Data Buku</a>
								</li>
							<!--	<li>
									<a href="?page=MyApp/data_agt">
					...
					<!--	<li class="treeview">
						...
						<li class="treeview">
							<a href="#">
								<i class="fa fa-book"></i>
								<span>Pinjam dan Kembali Buku</span>
								<span class="pull-right-container">
									<i class="fa fa-angle-left pull-right"></i>
								</span>
							</a>
							<ul class="treeview-menu">
								...
								<li>
									<a href="?page=pinjam_buku">
										<i class="fa fa-arrow-circle-o-down"></i>Peminjaman</a>
								</li>
								<li>
									<a href="?page=kembali_buku">
										<i class="fa fa-arrow-circle-o-up"></i> Pengembalian</a>
								</li>
							</ul>
						</li>
						...
						<li class="treeview">
							...
							<ul class="treeview-menu">
								...
								<li>
									<a href="?page=log_pinjam">
										<i class="fa fa-arrow-circle-o-down"></i>Riwayat Peminjaman</a>
								</li>
								<li>
									<a href="?page=log_kembali">
										<i class="fa fa-arrow-circle-o-up"></i>Riwayat Pengembalian</a>
								</li>
							</ul>
						</li>
				...
				if (isset($_GET['page'])) {
					...
					switch ($hal) {
						...
						case 'MyApp/data_buku':
							...
							break;
						case 'MyApp/data_buku_petugas':
							include "admin/buku/data_buku_petugas.php";
								break;
						case 'MyApp/add_buku':
						...
						case 'log_pinjam':
							...
							break;
						case 'pinjam_buku':
							include "admin/log/pinjam_buku.php";
							break;	
						case 'log_kembali':
							include "admin/log/log_kembali.php";
							break;
						case 'kembali_buku':
							include "admin/log/kembali_buku.php";
							break;
